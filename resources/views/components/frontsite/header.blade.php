		...
		<div class="flex justify-between h-16">
			<div class="flex flex-auto justify-between">
				...
				<a href="{{ route('index') }}" class="flex-shrink-0 flex items-center">
					<img class="h-12 lg:h-16 w-auto" src="{{ asset('/assets/frontsite/images/logo.svg') }}"
						alt="MedicalMeet Logo" />
				</a>
				...
				<div class="hidden lg:ml-6 lg:flex lg:space-x-12">
					...
					<a href=" #" class="text-[#1E2B4F] relative hover:text-gray-500 inline-flex items-center px-1 pt-1 text-lg font-medium">
						Featured
					</a>
					<a href="#"
			...
			<div class="hidden lg:ml-10 lg:flex lg:items-center">
				<a href="{{ route('login') }}"
					class="inline-flex items-center rounded-full text-[#0D63F3] text-lg font-medium bg-[#F2F6FE] hover:bg-[#0D63F3] hover:text-white transition px-10 py-3">
					Sign In
				</a>
			</div>
			...
			<div class="-mr-2 flex items-center lg:hidden">
				<button type="button"
					...
					<!--
						...
						-->
					<svg x-show="!navbarMobileOpen" class="block h-8 w-8" xmlns="http://www.w3.org/2000/svg" fill="none"
