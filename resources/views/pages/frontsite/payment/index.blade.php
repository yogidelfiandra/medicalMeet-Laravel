		...
		<div class="lg:col-span-7 lg:pl-8 lg:pr-20">
			...
			<div class="mt-16">
				...
				<div class="flex items-center justify-between mt-5">
					...
					{{-- <div class="text-[#1E2B4F] font-medium">{{ 'IDR
						'.number_format($appointment->doctor->specialist->price) ?? '' }}</div> --}}
				</div>

				<div class="flex items-center justify-between mt-5">
					<div class="text-[#AFAEC3] font-medium">Fee dokter</div>
					{{-- <div class="text-[#1E2B4F] font-medium">{{ 'IDR '.number_format($appointment->doctor->fee) ??
						'' }} --}}
					</div>
				</div>
