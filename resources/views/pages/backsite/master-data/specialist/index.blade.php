						...
						<div class="card">
							...
							<div class="card-content collapse hide">
								<div class="card-body card-dashboard">
									...
									<form class="form form-horizontal" action="{{ route('backsite.specialist.store') }}"
										...
										<div class="form-body">
											...
											<div class="form-group row">
												...
												<div class="col-md-9 mx-auto">
													<input type="text" id="name" name="name" class="form-control"
														placeholder="example dentist dermatology"
											...
											<div class="form-group row">
												...
												<div class="col-md-9 mx-auto">
													...
													@if($errors->has('price'))
													<p style="font-style: bold; color: red;">{{ $errors->first('price')
														}}</p>
													@endif
												</div>
											</div>
										...
										<table
											...
											<tbody>
												...
												<tr data-entry-id="{{ $specialist_item->id }}">
													<td>{{ isset($specialist_item->created_at) ? date("d/m/Y
														H:i:s",strtotime($specialist_item->created_at)) : '' }}</td>
