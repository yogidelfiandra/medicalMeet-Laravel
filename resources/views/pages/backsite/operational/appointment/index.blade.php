										...
										<table
											...
											<tbody>
												...
												<tr data-entry-id="{{ $appointment_item->id }}">
													<td>{{ isset($appointment_item->created_at) ? date("d/m/Y
														H:i:s",strtotime($appointment_item->created_at)) : '' }}</td>
													...
													<td>{{ isset($appointment_item->date) ?
														date("d/m/Y",strtotime($appointment_item->date)) : '' }}</td>
													<td>{{ isset($appointment_item->time) ?
														date("H:i:s",strtotime($appointment_item->time)) : '' }}</td>
													<td>
														@if($appointment_item->status == 1)
														<span class="badge badge-success">{{ 'Payment Completed'
															}}</span>
